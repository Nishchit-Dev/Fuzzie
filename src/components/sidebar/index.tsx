...
const SidebarMenuOptions = (props: Props) => {
                  ...
                  <TooltipTrigger>
                    <li>
                      <Link
                        href={menu.href}
                        className={clsx(
                          "group-8 h-8 w-8 flex items-center justify-center scale-[1.5] rounded-md p-[3px] cursor-pointer",
                          {
                            "dark:bg-[#2F0068] bg-[#EEE0FF]":
                              pathName === menu.href,
                          }
                        )}
                      >
